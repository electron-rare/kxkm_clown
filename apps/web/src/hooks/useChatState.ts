  ...
  const handleKeyDown = useCallback((e: React.KeyboardEvent) => {
    ...
    if (e.key === "Tab") {
      ...
      if (text.startsWith("/") && !text.includes(" ")) {
        const slashCommands = ["/help", "/clear", "/nick", "/join", "/channels", "/msg", "/web", "/imagine", "/compose", "/comp", "/layer", "/mix", "/remix", "/tracks", "/undo", "/solo", "/unsolo", "/rename", "/status", "/model", "/persona", "/context", "/responders", "/who", "/personas", "/export", "/memory", "/models", "/reload", "/topic", "/dm", "/pin", "/stats", "/ban", "/unban", "/mute", "/unmute", "/dice", "/roll", "/flip", "/changelog", "/version", "/whisper", "/w", "/history", "/search", "/react", "/invite", "/time", "/date", "/session", "/theme", "/fortune", "/speed", "/voice", "/fx", "/noise", "/ambient", "/dup", "/duplicate", "/bpm", "/clear-comp", "/loop", "/swap", "/info", "/normalize", "/crossfade", "/trim", "/stutter", "/pan", "/master", "/concat", "/silence", "/play", "/stop-all", "/template", "/marker", "/metronome", "/delete", "/suggest", "/snapshot", "/randomize", "/glitch", "/stretch", "/bounce"];
