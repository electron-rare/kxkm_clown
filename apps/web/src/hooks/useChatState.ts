  ...
  const handleKeyDown = useCallback((e: React.KeyboardEvent) => {
    ...
    if (e.key === "Tab") {
      ...
      if (text.startsWith("/") && !text.includes(" ")) {
        const slashCommands = ["/help", "/clear", "/nick", "/join", "/channels", "/msg", "/web", "/imagine", "/compose", "/comp", "/layer", "/mix", "/remix", "/tracks", "/status", "/model", "/persona", "/context", "/responders", "/who", "/personas", "/export", "/memory", "/models", "/reload", "/topic", "/dm", "/pin", "/stats", "/ban", "/unban", "/mute", "/unmute", "/dice", "/roll", "/flip", "/changelog", "/version", "/whisper", "/w", "/history", "/search", "/react", "/invite", "/time", "/date", "/session", "/theme", "/fortune", "/speed", "/voice", "/fx", "/noise", "/ambient"];
