      ...
      case "/help":
        send(ws, {
          ...
          text: [
            ...
            "/comp new|list|save|load|delete    \u2014 gerer les compositions multi-pistes",
            ...
            "/info <piste#>                       \u2014 details d'une piste (type, prompt, fichier)",
            "/normalize [piste#]                 \u2014 normaliser le volume (loudnorm)",
            "/crossfade <piste#> [duree_s]        \u2014 crossfade entre piste N et N+1",
            "/trim <piste#> <debut_s> <fin_s>     \u2014 decouper une piste",
            "/stutter <piste#> [x]              \u2014 glitch/stutter micro-loop (2-16 reps)",
            "/pan <piste#> <-1..1>               \u2014 positionnement stereo (gauche/droite)",
            ...
            "/metronome [BPM]                   \u2014 click track metronome (defaut 120)",
            "/delete <piste#>                   \u2014 supprimer une piste specifique",
